...
Ep <- format(summary(lm_ler)$coefficients[5,1],digits=2,nsmall=2)
...
plot(subset$date_time ,subset$ler, ylab = "LER", xlab = "time", col = "grey")
lines(subset$date_time, subset$ler, col = "grey")
points(subset$date_time, subset$pred_ler,col="darkslategray2")
lines(subset$date_time, subset$pred_ler, col ="darkslategray2")
FunXPosition(0.5)
...
plot(subset$date_time, subset$l_cum, ylab = "l_cum [mm]", xlab = "time")
lines(subset$date_time, subset$l_cum)
points(subset$date_time, subset$pred_l_cum, col = "blue")
lines(subset$date_time, subset$pred_l_cum, col = "blue")


plot(lm_ler$residuals, xlab = "time", ylab = "residuals")
lines(lm_ler$residuals)
abline(h = 0, col = "blue")
